package Lec03_Variables.com.lec.java.printf;
...
//        서식문자열 안에 %로 시작하는 서식문자들...
        ...
        System.out.printf("원주율 %f", pi);   // %f : 실수출력 포맷 (소숫점 6자리까지)
        System.out.printf("원주율 %.2f", pi);  // %.2f : 소숫점 2자리까지
