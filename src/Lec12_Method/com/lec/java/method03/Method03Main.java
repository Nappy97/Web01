package Lec12_Method.com.lec.java.method03;
...
public class Method03Main {
    ...
    public static void main(String[] args) {
        ...
        //                                        ↓   
        //                        println(                     )
        System.out.println("calcGrade(calcAvg(calcTotal(korean, english, math))) = " + calcGrade(calcAvg(calcTotal(korean, english, math))));
