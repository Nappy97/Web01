package Lec05_Operator.com.lec.java.operator08;
...
public class Operator08Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("| result = " + Integer.toBinaryString(result)); // 1111
        ...
        System.out.println("~ result(10진수) = " + result);
        System.out.println("~ result(2진수) = " + result);
        ...
        result2 = n3 << 3;
        System.out.println("<<3 result = " + result2);
